...
import type { Inspector, Site } from '../types/inspection';
import { TrainingLabelingPanel } from '../components/TrainingLabelingPanel';

type Tab = 'inspectors' | 'sites' | 'staging' | 'security' | 'reports' | 'training' | 'diagnostics';
    ...
    <main>
      <div className="page-head">
        <div>
          ...
          <div className="page-head__sub">
            Manager-only{config ? ` · ${config.siteName}` : ' · no site assigned to this iPad yet'}
          </div>
        </div>
      ...
      {!config && (
        <div className="banner banner--warn">
          ...
          <div className="banner__body">
            <strong>This iPad isn't assigned to a site yet.</strong> Create a site below, then
            go to Device setup (the home screen will redirect you) to assign this iPad to that
            site.
          </div>
        </div>
      )}
      ...
      <div className="admin-tabs">
        <button
          ...
          disabled={!config}
          title={!config ? 'Assign this iPad to a site first' : undefined}
        >
          Inspectors
        </button>
        <button
        ...
        <button
          className={`admin-tab ${tab === 'training' ? 'active' : ''}`}
      ...
      {tab === 'training' && <TrainingLabelingPanel />}
    ...
    <>
      <section className="section">
        ...
        <div className="banner banner--info">
          <span className="banner__icon">i</span>
          <div className="banner__body">
            This password is stored on the iPad and shared across all managers using this device.
