      ...
      <div className="page-head">
        <div>
          ...
          <div className="page-head__sub">
            One-time configuration. After this, the iPad knows which site it belongs to.
          </div>
        </div>
      </div>
      ...
      {noSites ? (
        ...
        <>
          <div className="banner banner--info">
            ...
            <div className="banner__body">
              Pick the site this iPad will be assigned to. If you need a new site, you can add
              one inline below.
            </div>
          </div>
