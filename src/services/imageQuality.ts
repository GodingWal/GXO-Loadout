...
// subtle issues. When the inspector chooses "Keep anyway" on a flagged photo,
// the photo is auto-marked for ML training so we can build a better model
// from real warehouse images later.
...
export interface QualityIssue {
  ...
  message: string;
  score: number; // raw score for debugging / future ML training
}

export interface QualityCheckResult {
  passed: boolean;
  issues: QualityIssue[];
  // Raw metrics for collecting training data
  metrics: {
    blurScore: number;
